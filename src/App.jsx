        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white p-8 sm:p-12 rounded-[2.5rem] shadow-2xl border border-slate-100">
            <div className="flex gap-6 mb-10 border-b border-slate-100">
              ...
              <button onClick={() => { setIsLogin(false); setError(''); setMsg(''); }} className={`pb-4 font-black uppercase tracking-widest text-xs transition-all ${!isLogin ? 'border-b-4 border-[#d1ff64] text-black' : 'text-slate-300'}`}>Acceso VIP</button>
            </div>
